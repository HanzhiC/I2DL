...
class FullyConnectedNet(object):
    ...
    def loss(self, X, y=None):
        ...
        for layer_index in range(1, self.num_layers):
          layer[layer_index],layer_cache[layer_index] = affine_bn_relu_forward(layer[layer_index-1], 
        ...
        scores, cache_scores = affine_forward(layer[self.num_layers - 1], W_last, b_last)
        ...
        dx_last, dW_last, db_last = affine_backward(dloss, cache_scores) 
        ...
        for layer_index in range(self.num_layers-1, 0, -1):
          dx, dw, db, dgamma, dbeta = affine_bn_relu_backward(x_grads[layer_index], layer_cache[layer_index])
          ...
          grads.update({'W'+str(layer_index): dw,
                        ...
                        'gamma'+str(layer_index): dgamma,
                        'beta'+str(layer_index): dbeta,
                      })
        #######################################################################
        #                             END OF YOUR CODE                        #
        #######################################################################
